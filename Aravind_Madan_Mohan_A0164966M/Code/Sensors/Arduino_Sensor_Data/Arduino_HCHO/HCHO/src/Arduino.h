...
#define SPECIAL           0xF8 defaults to the usable BUSes uart0rxtx uart1tx and hspi
...
timer dividers
enum TIM_DIV_ENUM {
  TIM_DIV1 = 0,   80MHz (80 ticksus - 104857.588 us max)
  TIM_DIV16 = 1,  5MHz (5 ticksus - 1677721.4 us max)
...
#define timer0_write(count) __asm__ __volatile__(wsr %0,ccompare0; esynca (count)  memory)
...
#include umm_mallocumm_malloc_cfg.h
#endif